...
interaction, and Chrome evicts whole origins under pressure. Losing a player's work takes no server
failure at all — the browser can do it unprompted, with nothing to appeal to. Everything in
