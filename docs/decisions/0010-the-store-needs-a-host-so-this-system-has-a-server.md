...
- **Rent somebody else's backend instead of having one** — a backend-as-a-service holding the store,
  ...
  it would satisfy [ADR-0009](0009-the-durable-copy-of-a-players-state-is-not-on-their-device.md) without this record. Rejected because it satisfies [ADR-0012](0012-puzzle-content-is-served-by-a-runtime-not-bundled.md) only
...
- **The store turns out to be something with no host of ours** — a managed service the client reaches
  directly. That satisfies [ADR-0009](0009-the-durable-copy-of-a-players-state-is-not-on-their-device.md) without this record, and it is the live alternative named under
