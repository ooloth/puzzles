...
2. **A browser shows "Hello!" rendered by the client, locally.**
   ...
   - **Given:** [0027-the-floor-declaration-is-a-browserslist-config](../decisions/0027-the-floor-declaration-is-a-browserslist-config.md) — so the bundler must consume a browserslist config
