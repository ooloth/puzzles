...
**Android is the larger share of the market and the smaller share of what this repo knows.** Chrome
for Android is roughly 60% of mobile browsing worldwide against Safari on iPhone at about 26%,
rising above 70% in Africa and Asia. Every storage-behaviour fact in
[../constraints.md](../constraints.md) is WebKit-sourced, so the recorded knowledge covers the
smaller population. **The market-share figures are not in that file** — they are sourced below and
live here only.
