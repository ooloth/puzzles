...
The most consequential gap in the priority ranking. A fast local answer that a fuller check
would contradict is exactly the failure that hurts most here: a late error invalidates the
